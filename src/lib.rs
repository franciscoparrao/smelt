...
pub mod prelude {
    ...
    pub use crate::learner::{Learner, DecisionTree, KNearestNeighbors, LinearRegression, LogisticRegression, RandomForest, GradientBoosting, ExtraTrees, GaussianNB, Ridge, Lasso, ElasticNet, AdaBoost, LinearSVM, XGBoost, GeoXGBoost, ObliqueTree, ObliqueForest, Stacking, QuantileGB, QuantileForest, EBM, Bagging};
